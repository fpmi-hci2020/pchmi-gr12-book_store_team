...
class RentPage extends Component {
    ...
    removeFromCart = () => {
        ...
        const booksToRemove = inCart.filter(book => bill.filter(billBook => billBook.id === book.id))
                    ...
                    <div className='content'>
                        <div className='left_container'>
                            <div className='orders'>
                                <BasketCardGroup orders={this.state.cardsData} addToBill={this.addToBill} removeFromBill={this.removeFromBill} />
                            </div>
                        </div>
                        ...
                        <div className='order_list'>
                                ...
                                <Button text={'Оплатить заказ'} onClick={this.payForOrder} type={'button'} classes={'order_list'} />
                            </div>
                        </div>
                    </div>
                </div>
